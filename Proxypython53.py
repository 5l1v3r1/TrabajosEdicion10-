...
if sys.argv[2:]:
 ...
 msg1 = '<font color="blue">AQUI</font> <font color="green">CONNECT TO REAL STRATEGY</font>'
...
def test(HandlerClass=SimpleHTTPProxyHandler, ServerClass=ThreadingHTTPServer, protocol="HTTP/1.1"):
    ...
    print "PROXY PYTHON rs iniciado:", sa[0], "port", sa[1], "..."
    print "\n: AHORA SALGA DE LA TERMINAL Y PRUEBE EL SU PROXY:\n" 
    httpd.serve_forever()
